    ...
    public function execute()
    {
        try {
            ...
            if ($actparterprocost) {
                ...
                $message = ("Payment has been successfully done for Transaction No - ".$transactionNumber." ."); 
                ...
                if (preg_match('/^\+?\d+$/', $sellerEmail)){
                    ...
                    $this->messageManager->addSuccess(__('Payment has been successfully done for this seller via phone number.'));
                }
                else 
                {
                    ...
                    $this->messageManager->addSuccess(__('Payment has been successfully done for this seller via mail.'));
